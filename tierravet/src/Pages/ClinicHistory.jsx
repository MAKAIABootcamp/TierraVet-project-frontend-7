...
<form onSubmit={formik.handleSubmit}>
      <div className="block mt-4 ml-16 mr-16 relative bg-white border border-secondary focus:outline-none focus:border-secondary focus:ring-secondary rounded-xl sm:text-xl focus:ring-1 ">
        ...
        <span className="flex justify-center mt-6">
          <p className="mr-20">T: <input type="text" name="temperature" className="border-b w-20 border-black" onChange={formik.handleChange} value={formik.values.temperature} />°C</p>
          <p className="mr-20">FC: <input type="text" name="heartRate" className="border-b w-20 border-black" onChange={formik.handleChange} value={formik.values.heartRate} />LPM</p>
          <p className="mr-20">FR: <input type="text" name="respiratoryRate" className="border-b w-20 border-black" onChange={formik.handleChange} value={formik.values.respiratoryRate} />RPM</p>
          <p className="ml-20">SPO2: <input type="text" name="spo2" className="border-b w-20 border-black" onChange={formik.handleChange} value={formik.values.spo2} />%</p>
          <p className="ml-20">TLLC: <input type="text" name="tllc" className="border-b w-20 border-black" onChange={formik.handleChange} value={formik.values.tllc} />SEG</p>
        </span>
        <span className="flex justify-center mt-6 ml-8">
          <p className="mr-20">GLUCOMETRÍA: <input type="text" name="glucometry" className="border-b w-20 border-black" onChange={formik.handleChange} value={formik.values.glucometry} />MG/DL</p>
          <p className="mr-20">PA: <input type="text" name="bloodPressure" className="border-b w-20 border-black" onChange={formik.handleChange} value={formik.values.bloodPressure} />MMGH</p>
          <p className="mr-20">MUCOSAS: <input type="text" name="mucosas" className="border-b w-20 border-black" onChange={formik.handleChange} value={formik.values.mucosas} /></p>
          <p>CC: <input type="text" name="cc" className="border-b w-20 border-black" onChange={formik.handleChange} value={formik.values.cc} /></p>
        </span>
        ...
        <label className="flex ml-16">
          ...
          <div>
            <button className="bg-secondary shadow-lg mb-4 mt-10 hover:bg-primary text-white py-3 px-16 lg:text-left lg:inline-block lg:mr-2 rounded-xl sm:text-2xl">
              <FontAwesomeIcon icon={faHospital} className="mr-2" /> ABORDAJE CLÍNICO
            </button>
          </div>
        </label>
        <label className="flex ml-16">
        <div>
            <button className="bg-secondary shadow-lg mb-4 hover:bg-primary text-white py-3 px-16 lg:text-left lg:inline-block lg:mr-2 rounded-xl sm:text-2xl">
              <FontAwesomeIcon icon={faFlask} className="mr-2" /> EXÁMENES COMPLEMENTARIOS
            </button>
          </div>
        </label>
